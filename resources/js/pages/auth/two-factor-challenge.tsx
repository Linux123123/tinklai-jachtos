...
export default function TwoFactorChallenge() {
    ...
    const authConfigContent = useMemo<{
        ...
        if (showRecoveryInput) {
            return {
                title: 'Atkūrimo kodas',
                description: 'Prašome patvirtinti prieigą prie savo paskyros įvedę vieną iš avarinių atkūrimo kodų.',
                toggleText: 'prisijungti naudojant autentifikavimo kodą',
            };
        }

        return {
            title: 'Autentifikavimo kodas',
            description: 'Įveskite autentifikavimo kodą, kurį pateikė jūsų autentifikavimo programa.',
            toggleText: 'prisijungti naudojant atkūrimo kodą',
        };
    }, [showRecoveryInput]);
                            ...
                            {showRecoveryInput ? (
                                <>
                                    <Input
                                        name="recovery_code"
                                        type="text"
                                        placeholder="Įveskite atkūrimo kodą"
